    ...
    with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as sock:
        ...
        while True:
            ...
            len_encoded_hello_msg = int.from_bytes(b_len_encoded_hello_msg,
                                                   byteorder='big')
            encoded_hello_msg = recvall(connection, len_encoded_hello_msg)
            _, _, p, g, a_x, _ = asn1.decode(encoded_hello_msg)

            elgamal = gamal.ElGamal(p=p, g=g)
            ...
            ciph_hello_msg_key = elgamal.encrypt_msg(a_x, hello_msg_key)
            encoded_hello_msg = asn1.encode(a_y=shared_key,
                                            c=ciph_hello_msg_key,
            ...
            hello_msg_key = elgamal.decrypt_msg(a_x, c)
